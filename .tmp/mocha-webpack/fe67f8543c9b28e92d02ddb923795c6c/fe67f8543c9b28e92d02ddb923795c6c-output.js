...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var __webpackManifest__ = ['./flag', './lib/chai', './chai/config', './transferFlags', './inspect', './isProxyEnabled', './addLengthGuard', './proxify', 'assertion-error', 'type-detect', './../webpack/buildin/global.js', './getActual', 'get-func-name', './getProperties', './objDisplay', './getOwnEnumerablePropertySymbols', './fe67f8543c9b28e92d02ddb923795c6c-entry.js', './anotherThing.spec.js', 'chai', './chai/utils', 'pathval', './test', './expectTypes', './getMessage', './getEnumerableProperties', 'deep-eql', './addProperty', './addMethod', './overwriteProperty', './overwriteMethod', './addChainableMethod', './overwriteChainableMethod', './compareByInspect', './getOwnEnumerableProperties', 'check-error', './isNaN', './chai/assertion', './chai/core/assertions', './chai/interface/expect', './chai/interface/should', './chai/interface/assert', '../src/anotherThing', './utils'];

    var testsContext = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chai__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chai___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_chai__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_anotherThing__ = __webpack_require__(43);
...
describe('anotherThing', () => {
    it('should add two things together', () => {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0_chai__["expect"])(__WEBPACK_IMPORTED_MODULE_1__src_anotherThing__["a" /* addTwoThings */](thing1, thing2)).to.equal(30);
    });
});
...
var pathval = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(44);


const addTwoThings = (thing1, thing2) => Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* add */])(thing1, thing2);
/* harmony export (immutable) */ __webpack_exports__["a"] = addTwoThings;
